...
// Start and stop values for the profiling.
struct timeval start_time[8], end_time[8];
...
#define FIB_32_BIT_LIMIT    (47)
#define FIB_ITERATIONS      (107500)

static void fib_test(uint32_t iterCnt) {
    uint32_t idx    = 0;
    uint32_t jdx    = 0;
    uint32_t fib    = 0;
    uint32_t fib0   = 0;
...
void *Sequencer(void *threadp)
{
    struct timeval current_time_val;
    /*
    We change this section of the code to change the sequencer rate and service schedule rates. 
    Delay time is in nanoseconds.
    */
    // struct timespec delay_time = {0,333333}; // delay for 33.33 usec, 3 kHz
    ...
    do
    {
        ...
        execution_time[0] = (end_time[0].tv_sec - start_time[0].tv_sec) * 1000.0; // seconds to milliseconds
        execution_time[0] += (end_time[0].tv_usec - start_time[0].tv_usec) / 1000.0; // microseconds to milliseconds
        WCET_0 = (WCET_0 < execution_time[0])?execution_time[0]:WCET_0;
        syslog(LOG_CRIT, "Service_0 WCET: %.2f milliseconds\n", WCET_0);
...
void *Service_1(void *threadp)
{
    ...
    while(!abortS1)
    {
        ...
        execution_time[1] = (end_time[1].tv_sec - start_time[1].tv_sec) * 1000.0; // seconds to milliseconds
        execution_time[1] += (end_time[1].tv_usec - start_time[1].tv_usec) / 1000.0; // microseconds to milliseconds
        WCET_1 = (WCET_1 < execution_time[1])?execution_time[1]:WCET_1;
        syslog(LOG_CRIT, "Service_1 WCET %.2f milliseconds\n", WCET_1);
    }
...
void *Service_2(void *threadp)
{
    ...
    while(!abortS2)
    {
        ...
        execution_time[2] = (end_time[2].tv_sec - start_time[2].tv_sec) * 1000.0; // seconds to milliseconds
        execution_time[2] += (end_time[2].tv_usec - start_time[2].tv_usec) / 1000.0; // microseconds to milliseconds
        WCET_2 = (WCET_2 < execution_time[2])?execution_time[2]:WCET_2;
        syslog(LOG_CRIT, "Service_2 WCET: %.2f milliseconds\n", WCET_2);
    }
...
void *Service_3(void *threadp)
{
    ...
    while(!abortS3)
    {
        ...
        execution_time[3] = (end_time[3].tv_sec - start_time[3].tv_sec) * 1000.0; // seconds to milliseconds
        execution_time[3] += (end_time[3].tv_usec - start_time[3].tv_usec) / 1000.0; // microseconds to milliseconds
        WCET_3 = (WCET_3 < execution_time[3])?execution_time[3]:WCET_3;
        syslog(LOG_CRIT, "Service_3 WCET: %.2f milliseconds\n", WCET_3);
    }
...
void *Service_4(void *threadp)
{
    ...
    {
        sem_wait(&semS4);
        gettimeofday(&start_time[4], NULL);
        fib_test(FIB_ITERATIONS);
        S4Cnt++;
        ...
        gettimeofday(&end_time[4], NULL);
        execution_time[4] = (end_time[4].tv_sec - start_time[4].tv_sec) * 1000.0; // seconds to milliseconds
        execution_time[4] += (end_time[4].tv_usec - start_time[4].tv_usec) / 1000.0; // microseconds to milliseconds
        WCET_4 = (WCET_4 < execution_time[4])?execution_time[4]:WCET_4;
        syslog(LOG_CRIT, "Service_4 WCET: %.2f milliseconds\n", WCET_4);
    }
...
void *Service_5(void *threadp)
{
    ...
    {
        sem_wait(&semS5);
        gettimeofday(&start_time[5], NULL);
        fib_test(FIB_ITERATIONS);
        S5Cnt++;
        ...
        gettimeofday(&end_time[5], NULL);
        execution_time[5] = (end_time[5].tv_sec - start_time[5].tv_sec) * 1000.0; // seconds to milliseconds
        execution_time[5] += (end_time[5].tv_usec - start_time[5].tv_usec) / 1000.0; // microseconds to milliseconds
        WCET_5 = (WCET_5 < execution_time[5])?execution_time[5]:WCET_5;
        syslog(LOG_CRIT, "Service_5 WCET: %.2f milliseconds\n", WCET_5);
    }
...
void *Service_6(void *threadp)
{
    ...
    {
        sem_wait(&semS6);
        gettimeofday(&start_time[6], NULL);
        fib_test(FIB_ITERATIONS);
        S6Cnt++;
        ...
        gettimeofday(&end_time[6], NULL);
        execution_time[6] = (end_time[6].tv_sec - start_time[6].tv_sec) * 1000.0; // seconds to milliseconds
        execution_time[6] += (end_time[6].tv_usec - start_time[6].tv_usec) / 1000.0; // microseconds to milliseconds
        WCET_6 = (WCET_6 < execution_time[6])?execution_time[6]:WCET_6;
        syslog(LOG_CRIT, "Service_6 WCET: %.2f milliseconds\n", WCET_6);
    }
...
void *Service_7(void *threadp)
{
    ...
    {
        sem_wait(&semS7);
        gettimeofday(&start_time[7], NULL);
        fib_test(FIB_ITERATIONS);
        S7Cnt++;
        ...
        gettimeofday(&end_time[7], NULL);
        execution_time[7] = (end_time[7].tv_sec - start_time[7].tv_sec) * 1000.0; // seconds to milliseconds
        execution_time[7] += (end_time[7].tv_usec - start_time[7].tv_usec) / 1000.0; // microseconds to milliseconds
        WCET_7 = (WCET_7 < execution_time[7])?execution_time[7]:WCET_7;
        syslog(LOG_CRIT, "Service_7 WCET: %.2f milliseconds\n", WCET_7);
    }
